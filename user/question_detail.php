...
$base = '../';
$page_title = 'Question Detail';
include __DIR__ . '/../includes/header.php';
?>

<div class="mb-3">
  <a href="questions.php" class="btn btn-sm btn-outline-secondary rounded-pill"><i class="fa-solid fa-arrow-left me-1"></i> Back to Q&amp;A Forum</a>
</div>
...
<div class="card card-sm p-4 mb-4">
  ...
  <h3 class="fw-bold mb-2"><?php echo htmlspecialchars($question['title']); ?></h3>
...
<h5 class="fw-bold mb-3"><i class="fa-solid fa-comments text-success me-2"></i> <?php echo $answers->num_rows; ?> Answer(s)</h5>

<?php while ($a = $answers->fetch_assoc()): ?>
  <div class="card card-sm p-4 mb-3 border-start border-4 border-success">
    <div class="d-flex align-items-center justify-content-between mb-2">
      ...
      <small class="text-muted fs-7"><?php echo date('d M Y, H:i', strtotime($a['created_at'])); ?></small>
    </div>
    <p class="mb-0 text-secondary"><?php echo nl2br(htmlspecialchars($a['answer_text'])); ?></p>
  </div>
<?php endwhile; ?>

<div class="card card-sm p-4 mt-4">
  <h6 class="fw-bold mb-3"><i class="fa-solid fa-reply text-primary me-2"></i> Contribute Your Answer</h6>
  <form method="POST">
    <div class="mb-3">
      <textarea name="answer_text" class="form-control" rows="4" required placeholder="Write a clear, helpful response to assist your peer..."></textarea>
    </div>
    <button type="submit" class="btn btn-sm-primary rounded-pill px-4"><i class="fa-solid fa-paper-plane me-1"></i> Post Solution</button>
  </form>
</div>
